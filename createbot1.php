<html class="no-js" lang="gr">
  <head>
    ...
    <title id="title">RoboJS createbot v1 (must use this. prefix)</title>
...
if($_POST!=null)  {
	require "createbotfile1.php";
}
  
  ?>
  <form action='' method="post" >
  Σημειωση: Πριν από κάθε εντολή βάλτε το "this." πχ this.ΜΠΡΟΣΤΑ(100)
  <pre>
